...
Class Master extends DBConnection {
	...
	function save_sub_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Sub Kategori Baru berhasil disimpan.");
			else
				$this->settings->set_flashdata('success',"Sub Kategori berhasil diperbarui");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_sub_category(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Sub Kategori berhasil dihapus.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_inventory(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Inventaris Baru berhasil disimpan.");
			else
				$this->settings->set_flashdata('success',"Inventaris berhasil diperbarui.");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_inventory(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Inventaris berhasil dihapus.");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
