	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">Nama Singkat Sistem</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Kebijakan pribadi</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Sampul Situs Web</label>
				<div class="custom-file">
