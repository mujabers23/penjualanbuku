...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=maintenance/manage_sub_category" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  membuat baru</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Apakah Anda yakin untuk menghapus sub kategori ini secara permanen?","delete_category",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
