...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Sub Kategori</h3>
	</div>
	<div class="card-body">
		<form action="" id="category-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
            <div class="form-group">
				<label for="parent_id" class="control-label">Kategori Induk</label>
			...
			<div class="form-group">
				<label for="sub_category" class="control-label">Nama Sub Kategori</label>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=maintenance/sub_category">Batal</a>
	</div>
</div>
<script>
