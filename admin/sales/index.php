    ...
    <div class="card-body">
        <form id="filter-form">
            <div class="row align-items-end">
                ...
                <div class="form-group col-md-3">
                    <label for="date_start">Tanggal Berakhir</label>
        ...
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Laporan penjualan</b></h3>
                <p class="text-center m-0">Tanggal antara<?php echo $date_start ?> and <?php echo $date_end ?></p>
                <hr>
            </div>
