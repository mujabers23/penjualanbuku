...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Produk</h3>
	</div>
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
				<label for="sub_category_id" class="control-label">Sub Kategori</label>
                <select name="sub_category_id" id="sub_category_id" class="custom-select" required>
                <option value="" selected="" disabled="">Pilih Kategori Pertama</option>
                <?php
			...
			<div class="form-group">
				<label for="title" class="control-label">Judul buku</label>
            ...
            <label for="author" class="control-label">Penulis</label>
                <small>(<i>Gunakan koma (,) untuk memisahkan nama Penulis</i>)</small>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="product-form">impan</button>
